...
DARKSIDE_BANNER = 'DarkSide v2.0 by Sn8ow'
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} DarkSide strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(DARKSIDE_BANNER)
    print()
    print(' USAGE: ./darkside.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        darkside = DarkSide(url)
        darkside.useragents = useragents
        darkside.nr_workers = workers
        darkside.method = method
        darkside.nr_sockets = socks
